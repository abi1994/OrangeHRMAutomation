package com.abi.test.pageobject.Pages.DashBoard;
...
public class Assign_Leave_Page extends PageBase {
    private static final Logger LOGGER =Logger.getLogger(Assign_Leave_Page.class);
