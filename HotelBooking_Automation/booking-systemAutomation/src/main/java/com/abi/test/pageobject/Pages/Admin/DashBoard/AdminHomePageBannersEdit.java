...
public class AdminHomePageBannersEdit extends PageBase {
    private static final Logger LOGGER =Logger.getLogger(AdminHomePageBannersEdit.class);
    ...
    private static By BannerImageUpload =By.xpath("//*[@id=\"content\"]/div/div/div[2]/div/form/table/tbody/tr[1]/td/input[1]");
